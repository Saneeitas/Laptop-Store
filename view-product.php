        ...
        <div class="cards-container">
            <figure class="card" style="width: 300px;">
                <div class="card__hero">
                    <img src="<?php echo $result2["image"]; ?>" alt="" class="card__img">
                </div>
                <h2 class="card__name"><?php echo $result2["productName"]; ?></h2>
                <p class="card__detail"><span class="emoji-left">🖥</span><?php echo $result2["screen"]; ?></p>
                <p class="card__detail"><span class="emoji-left">🧮</span> <?php echo $result2["cpu"]; ?></p>
                <div class="card__footer">
                    <p class="card__price">$<?php echo $result2["price"]; ?></p>
                    <p class="card__price"><?php echo $result2["description"]; ?></p>
